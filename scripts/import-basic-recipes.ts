...
async function importBasicRecipes() {
  console.log('🍳 Importing Basic Recipes...\n');

  // Read CSV file
  const csvPath = path.join(process.cwd(), 'basic_recipes.csv');
  ...
  console.log(`🍳 Basic recipes added to database!`);
}
