...
async function importFishRecipes() {
  console.log('🐟 Importing Fish & Seafood recipes...\n');

  // Read CSV file
  const csvPath = path.join(process.cwd(), 'kitchen_stories_fish_recipes.csv');
  ...
  console.log(`🐟 Fish & Seafood recipes added to database!`);
}
